...
standardized_data <-
  # pull in unbiased group means for inputs
...
Notes:
  ...
  * `language_english`: this predictor's main effect is not statistically significant, and hence it should only be interpreted in the context of its interactions (refer to `personal_income`).