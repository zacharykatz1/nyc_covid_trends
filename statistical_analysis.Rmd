...
Let $S$ denote the set of PUMAs in NYC, and let $y_s$ denote our outcome of interest. We consider the latent variable model
...
```{r regression_diagnostics, fig.height=6.2, fig.width= 8, message=FALSE, warning=FALSE}
