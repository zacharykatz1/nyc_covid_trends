...
We now seek to validate our model and assess its goodness of fit. We begin by assessing to what extend our model satisfies the assumptions of OLS.
...
```{r}
# construct table of statistics to assess goodness of fit and reliability
best_model %>%
  ...
  # map to a kable table
  kbl(
    caption     = "Key Statistics for Assessment of Fit and Reliability"
    , col.names = c(
